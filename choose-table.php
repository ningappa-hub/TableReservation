                  ...
                  <div class="row">
                      <?php
                        ...
                        foreach ($result as $r) {
                          ...
                          // Check table availability using function
                          $stmt = $con->prepare("SELECT fn_is_table_available(?, ?, ?)");
                          $stmt->bind_param("iss", $res_id, $reservation_date, $reservation_time);
                          $stmt->execute();
                      ...
                      <?php 
                              ...
                              // Show table as booked
                      ?>
                      <div class="col-lg-3" style="min-height: 190px">
                        <p style="font-weight: bold; padding: ">Table <?php echo @$i += 1 ?> (Booked)</p>
                        <nav class="menu2">
                          <input type="checkbox" id="restTable<?php echo $table_id; ?>" name="table[]" value="<?php echo $table_id; ?>" class="menu-toggler2 restTable"  data-id="<?php echo $table_id; ?>" disabled>
                          <label for="menu-toggler2"></label>
                          <ul>
                            <?php
                              $sql2 = "SELECT * FROM `restaurant_chair` WHERE tbl_id = '$table_id';";
